 ...
 */
public class ModExpressionPart implements ExpressionPart {
    ...
    public ModExpressionPart(float left_value, float right_value) {
        this.left_value = left_value;
        this.right_value = right_value;
    }

    public ModExpressionPart(ExpressionPart left_expr, ExpressionPart right_expr) {
        this.left_expr = left_expr;
        this.right_expr = right_expr;
        values = 1;
    }

    public ModExpressionPart(float left_value, ExpressionPart right_expr) {
        this.left_value = left_value;
        this.right_expr = right_expr;
        values = 2;
    }

    public ModExpressionPart(ExpressionPart left_expr, float right_value) {
        this.left_expr = left_expr;
        this.right_value = right_value;
        values = 3;
    }
