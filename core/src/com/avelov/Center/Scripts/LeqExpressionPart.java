 ...
 */
public class LeqExpressionPart implements ExpressionPart {
    ...
    public LeqExpressionPart(float left_value, float right_value) {
        this.left_value = left_value;
        this.right_value = right_value;
    }

    public LeqExpressionPart(ExpressionPart left_expr, ExpressionPart right_expr) {
        this.left_expr = left_expr;
        this.right_expr = right_expr;
        values = 1;
    }

    public LeqExpressionPart(float left_value, ExpressionPart right_expr) {
        this.left_value = left_value;
        this.right_expr = right_expr;
        values = 2;
    }

    public LeqExpressionPart(ExpressionPart left_expr, float right_value) {
        this.left_expr = left_expr;
        this.right_value = right_value;
        values = 3;
    }
