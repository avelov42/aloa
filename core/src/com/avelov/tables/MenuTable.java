...
public class MenuTable extends DynamicTable
{
    public MenuTable()
    {
        ...
        newSimulationButton.addListener(new ChangeListener()
        {
            ...
            {
                MenuScreen.getInstance().pushTable(new AutomatonChoiceTable(AutomatonChoiceTable.Mode.New));
            }
        });
        ...
        savedSimulationsButton.addListener(new ChangeListener()
        {
            ...
            public void changed(ChangeEvent event, Actor actor)
            {
                MenuScreen.getInstance().pushTable(new AutomatonChoiceTable(AutomatonChoiceTable.Mode.Load));
            }
        });
